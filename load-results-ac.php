        ...
        <tr>
            ...
            <td class="fs-mini text-truncate">
                ...
                if ($assignments_marks_data["marks"] == "-") {
                    ?>
                    <button class="release-btn-2" disabled>Not Supported</button>
                    <?php
                } else {
                ?>
                    <button class="release-btn shadow" onclick="release_marks(<?php echo $assignments_marks_data['assignments_id'] ?>);">Release Marks</button>
                <?php
                }
                ?>
            </td>
